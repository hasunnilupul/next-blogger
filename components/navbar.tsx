...
const Navbar = () => {
    ...
    const [openSearchModal, setOpenSearchModal] = useState(false); // search modal show/hide state
    ...
    return (
        <>
                            ...
                            <div className="ml-4 flex items-center md:ml-6">
                                <div className="flex space-x-4">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => setOpenSearchModal(prevState => true)}
                                    >
                                ...
                                <Menu as="div" className="relative ml-6">
                                    <div>
                                        <MenuButton className="relative flex max-w-xs items-center rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-white">
                                            ...
                                            <Image alt="" src={user.imageUrl} className="h-8 w-8 rounded-full" width={256} height={256} />
                                        </MenuButton>
                                    </div>
                                    <MenuItems
                                        transition
                ...
                <DisclosurePanel className="md:hidden">
                    ...
                    <div className="border-t border-gray-200 pb-3 pt-4">
                        <div className="flex items-center px-5">
                            <div className="flex-shrink-0">
                                <Image alt="" src={user.imageUrl} className="h-10 w-10 rounded-full" width={256} height={256} />
                            </div>
                            <div className="ml-3">
            ...
            <SearchModal open={openSearchModal} onClose={() => setOpenSearchModal(prevState => false)}/>
        </>
    )
}
